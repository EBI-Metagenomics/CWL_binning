...
outputs:
  ...
  concoct_bins_refined:
    type: File[]
    outputSource: bin_refinement/bins_a
  metawrap_bins_refined:
    type: File[]
    outputSource: bin_refinement/bins_b
  maxbin2_bins_refined:
    type: File[]
    outputSource: bin_refinement/bins_c
...
steps:
  ...
  bin_refinement:
    in:
      first_bin_dir: metawrap_binning/concoct_bins
      sec_bin_dir: metawrap_binning/metabat2_bins
      third_bin_Dir: metawrap_binning/maxbin2_bins
    out:
      - bins_a
      - bins_b
      - bins_c
